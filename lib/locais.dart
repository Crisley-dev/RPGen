...
class LocalEncontro extends StatefulWidget {
  LocalEncontro({Key key}) : super(key: key);

  @override
  _LocalEncontroState createState() => _LocalEncontroState();
}

class _LocalEncontroState extends State<LocalEncontro> {
  @override
